...
<footer>
  <div class="container mt-5">
    <div class="d-flex justify-content-center py-3">
      <ul class="nav col-12 col-md-auto justify-content-center mb-md-0">
        ...
        <li class="nav-item"><a href="<?php echo SITE_URL ?>/Views/trade_posts/FeedMusical.php" class="nav-link border-button text-white">Feed Musical</a></li>
        <li class="nav-item"><a href="<?php echo SITE_URL ?>/Views/trade_posts/MusicTradeCenter.php" class="nav-link border-button text-white">Music Trade Center</a></li>
      </ul>
    </div>
    <hr class="my-3">
  </div>
  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3">
      <a href="<?php echo SITE_URL ?>/Views/about/about.php" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none"><img src="../../images/icon.png" class="img-fluid" alt="" width="45px" height="45px"></a>      
      ...
      <div class="col-md-4 text-end">
        ...
        <a class="text-white" href="<?php echo SITE_URL ?>/Views/about/about.php">Music Trade Center</a>
      </div>
