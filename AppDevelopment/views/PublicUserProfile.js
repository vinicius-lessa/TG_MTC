 ...
 * File DOC
 * 
 * @Description Página 'UserProfile', que irá exibir informações sobre o Perfil de qualquer usuário do sistema (sem permições de edição).
 * @ChangeLog 
 *  - Vinícius Lessa - 22/06/2022: Criação do Arquivo com base no arquivo 'UserProfiel.js'. Primeiras adaptações.
 * 
 */
...
const PublicUserProfile = ( {route, navigation} ) => {    

  // Params Received
  const { userId, userName, userProfilePic, userEmail } = route.params
